    ...
    (function (n) {
        ...
        var t = function () {
            function t(n) {
                ...
                try { this._config.disableTelemetry() || (this._buffer.length && (r = this._config.emitLineDelimitedJson() ? this._buffer.join("\n") : "[" + this._buffer.join(",") + "]", this._sender(r, i)), this._lastSend = +new Date); this._buffer.length = 0; clearTimeout(this._timeoutHandle); this._timeoutHandle = null } catch (u) { n._InternalLogging.throwInternalNonUserActionable(0, "Telemetry transmission failed, some telemetry will be lost: " + n.Util.dump(u)) }
            ...
            (function (t) {
                ...
                var i = function () {
                    function t() { } return t.sanitizeKeyAndAddUniqueness = function (n, i) {
                        ...
                        if (n) {
                            r = {};
                            for (i in n) u = t.sanitizeString(n[i]), i = t.sanitizeKeyAndAddUniqueness(i, r), r[i] = u; n = r
                        }
                        return n
